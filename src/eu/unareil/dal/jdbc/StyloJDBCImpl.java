...
public class StyloJDBCImpl implements DAO<Stylo> {
    ...
    public void insert(Stylo data) throws DALException {
        try (
                ...
                PreparedStatement preparedStatement = connection.prepareStatement(SQL_INSERT_INTO, PreparedStatement.RETURN_GENERATED_KEYS);
        ) {
    ...
    public Stylo selectById(long id) throws DALException {
        try (Connection connection = JdbcTools.getConnection();
            ...
            if(resultSet.next()){
                return new Stylo(
                        resultSet.getLong("refProd"),
                        resultSet.getString("libelle"),
                        resultSet.getString("marque"),
                        resultSet.getFloat("prixUnitaire"),
                        resultSet.getLong("qteStock"),
                        resultSet.getString("couleur"),
                        resultSet.getString("typeMine")
                );
            }else{
